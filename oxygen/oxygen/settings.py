...
SECRET_KEY = 'django-insecure-od14p7z+p%)wg(_px#afh19c79&8cp+y5d87$pwp+ah$xjutmj'
...
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://oxytech-1aec5-default-rtdb.asia-southeast1.firebasedatabase.app/'
})
